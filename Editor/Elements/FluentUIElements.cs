...
namespace VRLabs.AV3Manager
{
	public static class FluentUIElements
	{
		...
		public static IntegerField NewIntField(string label, int value, int maxLength = -1) =>
			NewIntField(label, "", value, maxLength);
		...
		public static FloatField NewFloatField(string label, float value, int maxLength = -1) =>
			NewFloatField(label, "", value, maxLength);

#if UNITY_2022_1_OR_NEWER
		public static T WithScrollerVisibility<T>(this T control,
			ScrollerVisibility horizontal = ScrollerVisibility.Auto,
			ScrollerVisibility vertical = ScrollerVisibility.Auto) where T : ScrollView
		{
...
#else
        public static T WithScrollbarVisibility<T>(this T control, bool showHorizontal = true, bool showVertical =
 true) where T : ScrollView
        {
            control.showVertical = showVertical;
            control.showHorizontal = showHorizontal;
            return control;
        }
#endif
		...
		public static T WithFlex<T>(this T control, StyleFloat grow, StyleFloat shrink, StyleLength basis)
		...
		public static T WithMargin<T>(this T control, StyleLength marginLeft, StyleLength marginTop,
			StyleLength marginRight, StyleLength marginBottom) where T : VisualElement
		{
		...
		public static T WithMargin<T>(this T control, StyleLength marginLeftRight, StyleLength marginTopBottom)
			where T : VisualElement
		...
		public static T WithPadding<T>(this T control, StyleLength paddingLeft, StyleLength paddingTop,
			StyleLength paddingRight, StyleLength paddingBottom) where T : VisualElement
		{
		...
		public static T WithPadding<T>(this T control, StyleLength paddingLeftRight, StyleLength paddingTopBottom)
			where T : VisualElement
