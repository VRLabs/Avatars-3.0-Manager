...
namespace VRLabs.AV3Manager
{
    ...
    public static class AV3ManagerFunctions
    {
        ...
        public static void AddParameter(VRCAvatarDescriptor descriptor, VRCExpressionParameters.Parameter parameter, string directory, bool overwrite = true)
        {
            ...
            {
                Debug.Log("Directory was not specified, storing new parameters asset in " + DEFAULT_AUTOGENERATED_DIRECTORY);
        ...
        public static void AddParameters(VRCAvatarDescriptor descriptor, IEnumerable<VRCExpressionParameters.Parameter> parameters, string directory, bool overwrite = true)
        {
            ...
            {
                if (descriptor.expressionParameters.CalcTotalCost() + parametersArray.GetCost(descriptor.expressionParameters.parameters) > VRCExpressionParameters.MAX_PARAMETER_COST)
                {
        ...
        public static void AddSubMenu(VRCAvatarDescriptor descriptor, VRCExpressionsMenu menuToAdd, string controlName, string directory, VRCExpressionsMenu.Control.Parameter controlParameter = null, Texture2D icon = null, bool overwrite = true)
        {
            ...
            {
                Debug.Log("Directory was not specified, storing new topmost menu in " + DEFAULT_AUTOGENERATED_DIRECTORY);
                directory = DEFAULT_AUTOGENERATED_DIRECTORY;
            }
        ...
        /// <param name="overwrite">Optionally, choose to not overwrite an asset of the same name in directory. See class for more info.</param>
        [Obsolete("This method has been replaced by the version using the VRC \"AnimLayerType\" and will be removed in future versions of the manager")]
        ...
        /// <param name="directory">The unique directory to store the new merged controller, ex. "Assets/MyCoolScript/GeneratedAssets/725638/".</param>
        /// <param name="overwrite">Optionally, choose to not overwrite an asset of the same name in directory. See class for more info.</param>
        public static void MergeToLayer(VRCAvatarDescriptor descriptor, AnimatorController controllerToAdd, AnimLayerType layer, string directory, bool overwrite = true)
        {
            if (descriptor == null)
            {
            ...
            {
                if ((AssetDatabase.LoadAssetAtPath(_defaultControllersPath[layer], typeof(AnimatorController)) as AnimatorController) == null)
                {
                    Debug.LogError("Couldn't find VRChat's default animator controller at path '" + _defaultControllersPath[layer] + "'! Merging was not performed.");
                    return;
                }
            }
            ...
            if (animatorLayerArray != null)
            {
                ...
                if (animatorLayerArray[animatorLayerIndex].isDefault || animatorLayerArray[animatorLayerIndex].animatorController == null)
                {
                    descriptor.customizeAnimationLayers = true;
                    animatorLayerArray[animatorLayerIndex].isDefault = false;
                    
                    AssetDatabase.CopyAsset(_defaultControllersPath[layer], path);
                    var controllerFromNew = AssetDatabase.LoadAssetAtPath(path, typeof(AnimatorController)) as AnimatorController;
                ...
                {
                    AssetDatabase.CopyAsset(AssetDatabase.GetAssetPath(animatorLayerArray[animatorLayerIndex].animatorController), path);
                }

                AnimatorController controllerOriginal = AssetDatabase.LoadAssetAtPath(path, typeof(AnimatorController)) as AnimatorController;
                AnimatorController mergedController = AnimatorCloner.MergeControllers(controllerOriginal, controllerToAdd);
